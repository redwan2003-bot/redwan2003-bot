...
<h3 align="center">
IAAC Bronze Medalist ’21 & ’23 · IASC Finalist ’19 & ’20 ·  
Hardware Specialist (R&D) & Backend Developer @ UIU Robotics Club ·  
EasyEDA Campus Ambassador · CSE @ United International University
</h3>
...
### 🧩 Selected Robotics & Hardware Projects

- **LFR PCB Chassis Optimization – HyperLine Robotics**  
  Re-engineered the PCB chassis motherboard for a high-speed Line Following Robot series, fixing routing flaws and component placement to maximize output stability during high-speed maneuvers.

- **Robo Soccer & Robo Race Platforms – UIU Robotics Club**  
  Led hardware engineering for Robo Soccer, Robo Race, and project showcasing robots, ensuring robust power distribution, signal integrity, and mechanical durability for national-level competitions.

- **ESP32 Low-Latency Control Backend**  
  Implemented low-latency communication protocols for ESP32-based robotic systems, bridging backend logic with real-time actuation and feedback.
